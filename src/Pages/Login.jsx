      ...
      <div className="h-[100vh] grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            <h3 className="text-2xl sm:text-4xl font-bold border bg-gray-100 pb-1 pt-2 px-4 rounded-md w-[30%]" style={{ fontFamily: "Grandstander" }}>
                  ...
                  >
                    {isLoading ? (
                      <svg className="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle className="opacity-100" cx="12" cy="12" r="10" stroke="url(#gradient)" strokeWidth="4"></circle>
                      </svg>
                    ) : (
                      <>Login</>
                    )}
